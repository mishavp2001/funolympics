...
export default function ChampionUpdateForm(props) {
  const {
    id: idProp,
    champion: championModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = championRecord
      ? { ...initialValues, ...championRecord }
      : initialValues;
    setName(cleanValues.name);
    setAddress(cleanValues.address);
    setRecords(cleanValues.records ?? []);
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Champion, idProp)
        : championModelProp;
      setChampionRecord(record);
    };
    queryData();
  }, [idProp, championModelProp]);
  React.useEffect(resetStateValues, [championRecord]);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Champion.copyOf(championRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "ChampionUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || championModelProp)}
